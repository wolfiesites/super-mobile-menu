...
module.exports = {
	...
	// Project options.
	projectURL: 'king.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: './assets/front/css/style.scss', // Path to main .scss file.
	styleDestination: './assets/front/css', // Path to place the compiled CSS file. Default set to root folder.
	...
	// Watch files paths.
	watchStyles: './assets/front/css/**/*.scss', // Path to all *.scss files inside css folder and inside them.
