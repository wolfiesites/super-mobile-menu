...
if(!function_exists('smm_get_font_icons')) {
// Font Awesome v. 4.6.
    function smm_get_font_icons() {

        $fontAwesomeArray = array(
            'fa-glass'                               => 'f000',
            'fa-music'                               => 'f001',
            'fa-search'                              => 'f002',
            'fa-envelope-o'                          => 'f003',
...
$justNameArray = [];
foreach($fontAwesomeArray as $key => $value) {
    $justNameArray[] = $key;
}
return $justNameArray;
}
}

if(!function_exists('smm_get_hamburgers')) {
    function smm_get_hamburgers() {
        $super_hamburger = ['hamburger--3dx',
        'hamburger--3dx-r',
        'hamburger--3dy',
        'hamburger--3dy-r',
        'hamburger--3dxy',
        ...
        return $super_hamburger;
    }
}
if(!function_exists('smm_get_menus')) {
    function smm_get_menus() {
        $speroMenus = get_terms( 'nav_menu', array( 'hide_empty' => true ) );
        $speroMenusRdy = [];
        foreach( $speroMenus as $key => $value ) {
            $speroMenusRdy[] = $value->name;
        }
        return $speroMenusRdy;
    }
}